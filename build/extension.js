...
let globalStorage = {}
console.log("The extension g03 has started");
let messageSayConfig = vscode.commands.registerCommand('g03.messageSayConfig',async function () {
let funcName = "message_say_config"; let pyVar = "python3";
...
context.subscriptions.push(messageSayConfig);
let menu = vscode.commands.registerCommand('g03.menu',async function () {
let funcName = "menu"; let pyVar = "python3";
        let py = spawn(pyVar, [pythonPath, funcName]);
