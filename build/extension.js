...
let globalStorage = {}
console.log("The extension messages has started");
let showChoices = vscode.commands.registerCommand('messages.showChoices',async function () {
let funcName = "show_choices"; let pyVar = "python3";
...
context.subscriptions.push(showChoices);
}
